...
const RightSection = () => {
  ...
  return (
    <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 md:left-0 md:translate-x-0 md:bottom-0 md:top-0 right-0 w-[160%] h-52 -rotate-12 md:h-full md:w-[40%] bottom-0 overflow-hidden">
