...
const RightSection = () => {
  ...
  return (
    <div className="fixed -bottom-24 left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:bottom-0 md:top-0 right-0 w-[140%] h-60 -rotate-12 md:rotate-0 md:h-full md:w-[40%] bottom-0 overflow-hidden">
